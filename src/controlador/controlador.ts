...
export const getEmpleadosXID = (req: Request, res: Response) =>
  new Promise((resolve, reject) => {
    ...
    cxMysql.getConnection((err, connection) => {
      ...
      connection.query(
        `Select * from empleado where legajo = '${id}'`,
        (err, results) => {
          if (err) console.error(err);
          res.send(results);
        }
...
export const insertEmpleados = (req: Request, res: Response) =>
  new Promise((resolve, reject) => {
    const { legajo, apellido, nombre, dni, sector, fechaIngreso, activo } =
      req.body;
...
export const updateEmpleados = (req: Request, res: Response) =>
  new Promise((resolve, reject) => {
    const { legajo, apellido, nombre, dni, sector, fechaIngreso, activo } =
      req.body;
    ...
    cxMysql.getConnection((err, connection) => {
      if (err) {
        ...
        let sql: string = `UPDATE empleado SET apellido=?, nombre=?, dni=?, sector=?, fechaIngreso=?,activo=? WHERE legajo=${req.params.legajo}`;
        connection.query(sql, values, (err, results) => {
          if (err) {
            console.error(err);
...
export const deleteEmpleados = (req: Request, res: Response) =>
  new Promise((resolve, reject) => {
    const id = parseInt(req.params.legajo);
    cxMysql.getConnection((err, connection) => {
      if (err) {
